...
# general arguments
parser.add_argument('--dataset', default='lara', type=str, help='dataset root path')
parser.add_argument('--netname', default='MemSAS+BRB', type=str, help='MAE-ST or MSGCN')
...
def eval():
    ...
    with torch.no_grad():
        ...
        test_accuracies.append(round(_scores[2][0], 3))
        test_editscores.append(round(_scores[2][1], 3))
        test_f1scores.append(round(_scores[2][2][2], 3))
